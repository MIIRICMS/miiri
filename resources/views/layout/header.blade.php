...
{{--          <img class="wd-30 ht-30 rounded-circle" src="{{ url('https://via.placeholder.com/30x30') }}" alt="profile">--}}
            <i class="link-icon wd-30 ht-30 rounded-circle " data-feather="user"></i>
        </a>
...
{{--            </li>--}}
            <li class="dropdown-item py-2">
              <a href="{{route('users.create')}}" class="text-body ms-0">
            ...
            <li class="dropdown-item py-2">
              <form method="post" action="{{route('logout')}}" class="text-body ms-0">
                ...
                <button style="border: none; background-color: white;" type="submit">Log Out</button>
              </form>
            </li>
          </ul>
        </div>
