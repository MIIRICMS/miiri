...
@section('title')
    <title>MIIRI| {{$program->title}}</title>
@endsection
                ...
                <div class="gva-breadcrumb-content">
                    <div id="block-gavias-gito-breadcrumbs"
                        ...
                        <div class="breadcrumb-style"
                             style="background-color: #CEF0EA;background-image: url({{asset($program->image)}});background-position: center center;background-repeat: no-repeat; background-size: cover">
                            <div class="container">
