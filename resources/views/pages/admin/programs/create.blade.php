...
@section('title')
    <title>MIIRI| Create Programs</title>
@endsection
...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Create Program</h4>
    </div>
</div>
...
{{--        <h6 class="card-title">Create Program</h6>--}}
        ...
        <form class="forms-sample" method="post" action="{{route('programs.store')}}" enctype="multipart/form-data">
            @csrf
