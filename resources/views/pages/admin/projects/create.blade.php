...
@section('title')
    <title>MIIRI| Create projects</title>
@endsection
...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Create Project</h4>
    </div>
</div>
...
{{--        <h6 class="card-title">Create project</h6>--}}
        ...
        <form class="forms-sample" method="post" action="{{route('projects.store')}}" enctype="multipart/form-data">
            @csrf
